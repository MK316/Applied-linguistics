...
st.set_page_config(page_title="Learning Space", layout="wide")

tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(
    ["📮 Padlet", "🌵 Links", "🌵 Github", "🌵 Vibe coding", "🌵 Collaboration", "🌵 Python", "🌵 Streamlit"]
)

COLLAB_README_URL = "https://raw.githubusercontent.com/MK316/Collaboration26/main/README.md"
PYTHON_README_URL = "https://raw.githubusercontent.com/MK316/Coding4ET/main/README.md"
STREAMLIT_MD_URL = "https://raw.githubusercontent.com/MK316/Applied-linguistics/main/pages/streamlit.md"
...
with tab5:
    ...
    try:
        md_text = load_markdown_from_url(COLLAB_README_URL)
        st.markdown(md_text)
...
with tab6:
    ...
    try:
        md_text = load_markdown_from_url(PYTHON_README_URL)
        st.markdown(md_text)
    except Exception as e:
...
with tab7:
    ...
    try:
        md_text = load_markdown_from_url(STREAMLIT_MD_URL)
        ...
        st.error(f"Could not load the Streamlit markdown file.\n{e}")
