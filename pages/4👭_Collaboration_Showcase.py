...
with tab1:
    ...
    PROJECTS = {
        ...
        "Pair 1 - Sentence by Sentence TTS": "https://github.com/MK316/Collaboration26/blob/main/mini-project/miniproject-sample.md",
        "Pair 2 - Verb Learning": "https://github.com/JHC0531/Mini-project/blob/main/README.md",
